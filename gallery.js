...
function preloadImages() {
    const images = ["images/fullsize1.jpg", "images/fullsize2.jpg", "images/fullsize3.jpg"];
    images.forEach((src) => {
        const img = new Image();
        img.src = src;
    });
...
function setupRollovers() {
    ...
    image1.onmouseout = () => image1.src = "images/thumbnail1.jpg";

    image2.onmouseover = () => image2.src = "images/fullsize2.jpg";
    image2.onmouseout = () => image2.src = "images/thumbnail2.jpg";

    image3.onmouseover = () => image3.src = "images/fullsize3.jpg";
    image3.onmouseout = () => image3.src = "images/thumbnail3.jpg";
}
